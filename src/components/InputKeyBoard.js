...
export default function InputKeyBoard(props) {
    return (
        <div className="input-keyboard" style={{ display: "flex", flexDirection: "row", margin: "2vh" }}>
            <Grid_1x1 value={"0"} fixed={true} posY={1} posX={1} handle_grid_1x1_click={() => props.hadleKeyDownEvent({ key: "0", keyCode: 48 })} selectedGrid={props.selectedGrid} conflicted={false} />
            <Grid_1x1 value={"1"} fixed={true} posY={1} posX={1} handle_grid_1x1_click={() => props.hadleKeyDownEvent({ key: "1", keyCode: 49 })} selectedGrid={props.selectedGrid} conflicted={false} />
            <Grid_1x1 value={"2"} fixed={true} posY={1} posX={1} handle_grid_1x1_click={() => props.hadleKeyDownEvent({ key: "2", keyCode: 50 })} selectedGrid={props.selectedGrid} conflicted={false} />
            <Grid_1x1 value={"3"} fixed={true} posY={1} posX={1} handle_grid_1x1_click={() => props.hadleKeyDownEvent({ key: "3", keyCode: 51 })} selectedGrid={props.selectedGrid} conflicted={false} />
